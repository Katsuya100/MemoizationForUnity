...
{
    public class LockFreeBooleanCacheValue<T> : IDictionary<bool, T>
    {
        private LockFreeCacheValue<T> _trueValue = new LockFreeCacheValue<T>();
        private LockFreeCacheValue<T> _falseValue = new LockFreeCacheValue<T>();
